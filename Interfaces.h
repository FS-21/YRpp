...
ILocomotion : IUnknown
{
	...
	virtual Matrix3DStruct __stdcall Draw_Matrix(int* key) = 0; //Fetch voxel draw matrix.
	virtual Matrix3DStruct __stdcall Shadow_Matrix(int* key) = 0;	//Fetch shadow draw matrix.
